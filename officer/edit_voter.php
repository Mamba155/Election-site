            ...
            <form action="" method="post" class="px-3 py-4" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-12 col-md-6 mb-4 rounded">
                        ...
                        <input type="text" name="firstName" value="<?= htmlspecialchars($firstName); ?>" class="form-control text-black" id="firstName" placeholder="Adams" required>
                    </div>
                    <div class="col-12 col-md-6 mb-4 rounded">
                        <label for="lastName">Last Name</label>
                        <input type="text" name="lastName" value="<?= htmlspecialchars($lastName); ?>" class="form-control text-black" id="lastName" placeholder="Williams" required>
                    </div>
                    <div class="col-12 col-md-6 mb-4 rounded">
                        <label for="email">Email Address</label>
                        <input type="email" name="email" value="<?= htmlspecialchars($oldVoter['email']); ?>" class="form-control text-black" id="email" placeholder="voter@example.com" required>
                    </div>
                    <div class="col-12 col-md-6 mb-4 rounded">
                        <label for="phone">Phone Number</label>
                        <input type="phone" name="phone" value="<?= htmlspecialchars($oldVoter['phone']); ?>" class="form-control text-black" id="phone" placeholder="09012345678" required>
                    </div>
                    <div class="col-12 col-md-6 mb-4 rounded">
                        <label for="address">Address</label>
                        <input type="text" name="address" value="<?= htmlspecialchars($oldVoter['address']); ?>" class="form-control text-black" id="address" placeholder="2, street, town, state." required>
                    </div>
                    <div class="col-12 col-md-6 mb-4 rounded">
                        <label for="idNo">ID Number</label>
                        <input type="text" name="idNo" value="<?= htmlspecialchars($oldVoter['id_number']); ?>" class="form-control text-black" id="idNo" placeholder="09012345678" maxlength="11" oninput="this.value = this.value.replace(/\D/g, '').slice(0, 11)" required>
                    </div>
                    ...
                    <div class="col-12 col-md-6 mb-4 rounded">
                        ...
                        <input type="password" name="password" value="<?= htmlspecialchars($oldVoter['password']); ?>" class="form-control text-black" id="password" placeholder="your password" required>
                    </div>
                    <div class="col-12 col-md-6 mb-4 rounded">
                        <label for="confirmPass">Confirm Password</label>
                        <input type="text" name="confirmPass" value="<?= htmlspecialchars($oldVoter['password']); ?>" class="form-control text-black" id="confirmPass" placeholder="confirm your password" required>
                    </div>
                </div>
