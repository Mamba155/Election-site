...
session_start();
    ...
    if (isset($_POST['submit'])) {
        ...
        $update = mysqli_query($database, "UPDATE `candidates` SET `name`='$name',`email`='$email',`position`='$position',`party`='$party',`picture`='$pictureLink',`manifesto`='$manifesto' WHERE `id` = '$id' ");
