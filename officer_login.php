...
session_start();
    ...
    if (isset($_SESSION["id"]) && isset($_SESSION["role"])) {
        ...
        if(isset($_POST['submit'])){
            ...
            $confirm = mysqli_query($database, "SELECT * FROM `officers` WHERE (`email` = '$email') AND (`password` = '$password') ");
            $officer = mysqli_fetch_array($confirm);

            if($officer > 0){
                $_SESSION['id'] = $officer['id'];
                $_SESSION['name'] = $officer['name'];
                $_SESSION['role'] = 'officer';
                $extra = 'officer/index.php';
...
<?php include("header.php"); ?>
    ...
    <section class="px-lg-5 justify-content-center">
        ...
        <div class="container mx-0 px-0 py-5">
            <div>
                <h2 class="text-center text-success mb-2">Sign-In</h2>
                <p class="text-center text-secondary mb-5">As an Election Officer</p>
            </div>
            <div class="row d-flex justify-content-center mb-5 px-lg-5 ">
                <div class="card items-center border-success shadow rounded col-10 col-md-8 col-lg-6" >
                    <div class="card-body py-5 px-4">
                        <form action="" method="POST">
                            ...
                            <hr/>
                            <button name="submit" type="submit" class="btn btn-success btn-lg col-12">Sign in</button>
